export default function Hero() {
  ...
  return (
    <section
      className="hero-fixed-bg relative h-screen w-full flex items-center justify-center overflow-hidden"
      style={{
    ...
    >
      ...
      >
        <p
          className="text-xs md:text-sm tracking-[8px] uppercase text-caramel mb-8"
        >
